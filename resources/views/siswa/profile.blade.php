					...
					<div class="profile-left">
						...
						<div class="profile-header">
							...
							<div class="profile-main">
								<img src="{{$siswa->getAvatar()}}" class="img-circle" width="150" height="150" alt="Avatar">
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="/siswa/{{$siswa->id}}/{{$mapel->id}}/deletenilai" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Mau di Hapus..?')">Delete</a>
											</td>
										</tr>
										@endforeach
									</tbody>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" action="/siswa/{{$siswa->id}}/nilai" enctype="multipart/form-data">
					{{csrf_field()}}
					...
					<div class="form-group{{$errors->has('nilai') ? 'has-error' : ''}}">
						...
						@if($errors->has('nilai'))
						<span class="halp-block">{{$errors->first('nilai')}}</span>
						@endif
					</div>
